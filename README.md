...
**Approach:** Ahn's most-played playlists were exported from Apple Music and enriched with musical metadata (BPM, key, mode, energy, danceability, valence, acousticness, time signature) to build a queryable dataset. The data was then analyzed and visualized interactively to surface patterns and test the hypothesis.
...
- [LinkedIn](https://www.linkedin.com/in/ahnlauriehenry/)
